...
1. **ファイルのダウンロード**
   ```bash
   git clone https://github.com/your-username/webxr-solar-system.git
   cd webxr-solar-system
   ```

2. **WebXRデバイスでアクセス**
   - Meta Quest: ブラウザで `index.html` を開く
   - HoloLens: Microsoft Edge で実行
   - PC: Chrome/Edge の WebXR 拡張機能
...
**🚀 今すぐ体験 - WebXR対応デバイスでindex.htmlを開くだけ！**
